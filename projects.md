...
permalink: /projects/
lang: en
description: "Morui's creative projects include an indie Unity game, manga, music, YouTube, Twitch, Minecraft servers, and development work."
...
<div class="project">
  ...
  <h3>YouTube</h3>
  <p>Videos on Minecraft, Zombix, Albion Online, and other games across different seasons.</p>
...
<div class="project">
  <span class="status done">Content</span>
  <h3>Twitch</h3>
  <p>Live Dota 2 streams, captain's-eye view of drafting and shotcalling.</p>
  <p><a class="project-link" href="https://www.twitch.tv/moruikablin" target="_blank" rel="noopener">Watch on Twitch →</a></p>
</div>

<div class="project">
  <span class="status done">Music</span>
  <h3>SoundCloud</h3>
  <p>Original tracks, released under the same name as everything else here.</p>
...
<div class="project">
  ...
  <h3>Manga</h3>
  <p>A story about a hero who finds himself in a world after a catastrophe — the same world as in the indie game. Hand-drawn and self-written. The project reached two chapters before being temporarily put on hold due to academic workload.</p>
</div>
